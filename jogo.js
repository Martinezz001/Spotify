...
function startGame() {
  ...
  document.getElementById("btn-resposta").addEventListener('click', (event) => {
    ...
    if (resposta == trackName) {
      // Correct answer, add 5 points
      points += 5;
      alert("Você Acertou, Parabéns! Pontos: " + points);
      document.getElementById("resposta").value = "";
      ...
      // Incorrect answer, deduct 2 points
      points -= 2;
      alert("Você errou, tente novamente! Pontos: " + points);
    }
  
    // Penalize for listening to the music again, deduct 1 point
    points -= 1;
  });
